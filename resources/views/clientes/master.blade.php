                ...
                <div class="col-md-3 left_col">
                    <div class="left_col scroll-view">
                        ...
                        <div class="navbar nav_title" style="border: 0;">
                            <a href="{{url('/clientes')}}" class="site_title"><!--<i class="fa fa-paw">--></i><span>Kontabb</span></a>
                        </div>
                        ...
                        <div class="profile">
                            <div class="profile_pic">
                                ...
                                @if (is_file("images/usuarios/". Auth::guard('logclientes')->user()->id.'.png'))
                                <img src="{{asset('images/usuarios/'.Auth::guard('logclientes')->user()->id.'.png')}}" alt="..."
                                     class="img-circle profile_img">
                                @elseif (is_file("images/usuarios/". Auth::guard('logclientes')->user()->id.'.jpg'))
                                <img src="{{asset('images/usuarios/'.Auth::guard('logclientes')->user()->id.'.jpg')}}" alt="..."
                                     class="img-circle profile_img">
                                @else
                            ...
                            <div class="profile_info">
                                <span>Bem Vindo,</span>
                                <h2>{{ Auth::guard('logclientes')->user()->nome_razaosocial }}</h2>
                            </div>
                        </div>
                        <!-- /menu prile quick info -->
                                ...
                                <li class="">
                                    <a href="javascript:;" class="user-profile dropdown-toggle" data-toggle="dropdown"
                                       aria-expanded="false">
                                        ...
                                        {{-- Carrega a imagem do avatar se existir --}}
                                        @if (is_file("images/usuarios/". Auth::guard('logclientes')->user()->id.'.png'))
                                        <img src="{{asset('images/usuarios/'.Auth::guard('logclientes')->user()->id.'.png')}}"
                                             alt="">{{ Auth::guard('logclientes')->user()->nome_razaosocial }}
                                        @elseif(is_file("images/usuarios/". Auth::guard('logclientes')->user()->id.'.jpg'))
                                        <img src="{{asset('images/usuarios/'.Auth::guard('logclientes')->user()->id.'.jpg')}}"
                                             alt="">{{ Auth::guard('logclientes')->user()->nome_razaosocial }}
                                        @else
                                    ...
                                    <ul class="dropdown-menu dropdown-usermenu animated fadeInDown pull-right">                              
                                        <li><a href="{{url('/clientes-sair')}}"><i class="fa fa-sign-out pull-right"></i> Sair</a>
                                        </li>
                                    </ul>
                                </li>
                                <!-- NOTIFICAÇÕES                        
